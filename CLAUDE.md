# Vaylo — regole del progetto

Vaylo stima il valore di un immobile a Milano sulle quotazioni ufficiali OMI
...
| Componenti Vaylo | `src/components/vaylo/` | qui va il nuovo |
