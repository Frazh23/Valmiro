...
| Build e registro | `docs/github-actions-build.yml` (da installare in `.github/workflows/`), `docs/build.md`, `docs/verifica-browser.md` | la build di produzione gira su GitHub Actions e Vercel; qui non si puo' |
