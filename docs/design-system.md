...
| `HeroFoto` | le fotografie della home: quattro in rotazione automatica su schermo largo (balconi, ingresso, finestra, cortile), la sola prima su telefono; punto focale per immagine, nessun comando, si ferma da sola quando la scheda e' nascosta, la sezione e' fuori vista o si compila il modulo |
